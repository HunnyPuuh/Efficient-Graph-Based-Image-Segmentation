...
Proof:By definition, in order for S to be too fine there is some pair of components for which the boundary threshold does not hold.There must be at least one edge between such
